...
# retorna par (lista de medias da amostra, ficha ) - "ficha" tem os dados imutaveis - Sexo, Numero,Idade,Grupo
	...
	l=[]
	MediaGeralTotal=0.0
	MediaGeralNarrativa=0.0
	lc=listadeclasses()
	nr=listadenarrativas()
	MediaClasses={}
	MediaNarrativas={}
	cSOMA=0.0
	pSOMA=0.0
	for i in n:
			...
			if item['Nome']==i:
				...
				for narrativa in nr:
					if item['Narrativa'] == narrativa:
						MediaGeralNarrativa=item['MediaGeral']+MediaGeralNarrativa
						MediaNarrativas[narrativa]=MediaGeralNarrativa/3 
				MediaGeralNarrativa=0.0
					

		dDados['MediaDasNarrativas']=MediaNarrativas
		...
		MediaGeralTotal=0 #zera para proximo sujeito
